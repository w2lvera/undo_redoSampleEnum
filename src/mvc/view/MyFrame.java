...
public class MyFrame extends JFrame {
    ...
    public MyFrame(State state,UndoMachine um) {
        this.state = state;
        this.um = um;
...
//                new SaveFile(state)));
        ...
        um.addObserver((SwitchUndo)menuItems.get(menuItems.size()-3));
        um.addObserver((SwitchRedo)menuItems.get(menuItems.size()-2));
        um.notifyMenu();
